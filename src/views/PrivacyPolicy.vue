<template>
  <div class="privacyPolicy mx-5 pb-3 text-justify flex flex-col items-center">
    ...
    <p>
      E-Mail: apps@markusscheuring.de
    </p>
    <p>
    ...
    <p>
      ...
      Art. 9 Abs. 1 DSGVO verarbeitet werden. Sofern Sie in die Speicherung von
      Cookies oder in den Zugriff auf Informationen in Ihr Endger&auml;t
      ...
      Ma&szlig;nahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des
      Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten,
      sofern diese zur Erf&uuml;llung einer rechtlichen Verpflichtung
      ...
      Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. &Uuml;ber die jeweils
